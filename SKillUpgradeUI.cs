...
public class SKillUpgradeUI : MonoBehaviour
{
    ...
    public static bool SkillUpgradeSwit;
    ...
    public void SetSwitValue()
    {
        if (SkillUpgradeSwit == true)
        {
            SkillUpgradeSwit = false;
        }
        else if (SkillUpgradeSwit == false)
        {
            SkillUpgradeSwit = true;
        }
    }
}
