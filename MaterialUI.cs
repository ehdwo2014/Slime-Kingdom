...
public class MaterialUI : MonoBehaviour
{
    ...
    public static bool SwitchMaterialUI = false;
    ...
    void Update()
    {
        ...
        if(SI.GetComponent<SelectedItem>().selectedMT.IsThisDesc == true)
        {
        ...
        if (SI.GetComponent<SelectedItem>().selectedMT.IsThisDesc == false)
        {
    ...
    public void SetSwitValue()
    {
        if (SwitchMaterialUI == true)
        {
            SwitchMaterialUI = false;
        }
        else if (SwitchMaterialUI == false)
        {
            SwitchMaterialUI = true;
        }
    }

    public void TurnOnSellUI()
    {
