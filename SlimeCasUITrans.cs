...
public class SlimeCasUITrans : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (SS.GetComponent<SlimeSelection>().SelectedSlime == null && CameraController.CameraPosition != 2)
        {
            SwitchCasUI = false;
        }
